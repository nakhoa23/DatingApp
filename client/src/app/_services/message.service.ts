...
export class MessageService {
  ...
  paginatedResult = signal<PaginatednResult<Message[]> | null>(null);
  ...
  sendMessage(username: string, content: string) {
    return this.hubConnection?.invoke('SendMessage', {recipientUsername: username, content}) // cái màu vàng {} là mình gửi giá trị tới server
  }
